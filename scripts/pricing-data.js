...
const SERVICE_PRICING = {
        ...
        groups: [
            {
                ...
                tiers: [
                    ...
                    { id: 'legacy', name: 'The Legacy', price: 16500, rawValue: 900,
                      includes: ['Two event days, up to 10 hours each', 'Second photographer both days', '1,200+ edited images', '3-5 minute wedding film', 'Same-day teaser reel', 'Premium 30-page album plus two parent copies'],
    ...
    'model-portfolio': {
        ...
        tiers: [
            ...
            { id: 'editorial', name: 'Editorial Story', price: 5500, includedEdits: 50, rawValue: 900,
              includes: ['Full day, up to 8 hours', '2-3 locations', '6 looks', '50 retouched images', 'Hair and makeup for the full day', '60-second behind-the-scenes reel'],
    ...
    'videography': {
        ...
        tiers: [
            { id: 'reels', name: 'Reel Pack', price: 1800,
              includedReels: 2, includedFilm: null, includedCutdowns: 0,
              includes: ['3 hours on location', '2 vertical reels', 'Colour grade, licensed music, captions', '5 working days', '1 revision round'],
            ...
            { id: 'halfday', name: 'Half-Day Production', price: 3200,
              ...
              includes: ['4 hours on location', '60-90 second film', '2 vertical cutdowns', 'Subtitles burned in and as .srt', '7 working days', '2 revision rounds', '12-month UAE licence'],
              excludes: ['Professional voiceover', 'Talent', 'Animated graphics', 'Drone', 'Permits'] },
            { id: 'fullday', name: 'Full-Day Production', price: 5800,
              includedReels: 1, includedFilm: '2-3min', includedCutdowns: 3,
              includes: ['8 hours, multiple locations', '2-3 minute candid film', '3 vertical cutdowns', '15-second teaser', 'Interview audio with lav and boom', '10 working days', '2 revision rounds'],
              excludes: ['Scriptwriting', 'Voiceover artist', 'Talent', 'Drone', 'Permits', 'Studio hire'] },
    ...
    'newborn': {
        ...
        tiers: [
            { id: 'studio', name: 'Newborn Studio', price: 1200, includedEdits: 15, rawValue: 350,
              includes: ['2-3 hours, baby-led', '3 setups', '15 edited images', '10-day delivery'],
              excludes: ['Family portraits', 'Prints', 'Home visit'] },
            { id: 'family', name: 'Newborn & Family', price: 1800, includedEdits: 25, rawValue: 600, popular: true,
              includes: ['3-4 hours', '5 setups', '25 edited images', 'Family and sibling portraits', 'Ten 6x8 prints'],
              excludes: ['Home visit', 'Album', 'Digital negatives'] },
            { id: 'firstyear', name: 'First Year Story', price: 3200, includedEdits: 60, rawValue: 900,
              includes: ['3 sessions across the year', '4 setups per session', '20 edited images per session', 'Hardcover album'],
    ...
    'product': {
        ...
        tiers: [
            ...
            { id: 'campaign', name: 'Campaign Day', price: 6800, includedEdits: 80, rawValue: 900,
              includes: ['Full shoot day', 'Up to 80 final images', 'Styled lifestyle, hero product, flat lays', 'Art direction and mood board', '10 working days'],
    ...
    'automobile': {
        ...
        rawFilesIncluded: true,
        tiers: [
            { id: 'owner', name: "Owner's Session", price: 1800, includedEdits: 20, rawValue: 350,
              includes: ['90 minutes', '1 vehicle', '1 location', '20 edited images', '5-day delivery', 'Personal use'],
              excludes: ['Video', 'Rolling shots', 'Permit fees', 'Commercial use'] },
            { id: 'goldenhour', name: 'Golden Hour Feature', price: 3400, includedEdits: 45, rawValue: 600, popular: true,
              includes: ['3 hours', '1-2 vehicles', '2 locations', '45 edited images', '15-second vertical reel', 'Rolling shots at legal speeds'],
              excludes: ['Permit and location fees', 'Drone', 'Closed-road access', 'Commercial use'] },
            { id: 'commercial', name: 'Commercial / Dealer', price: 4500, fromPrice: true, includedEdits: 60, rawValue: 900,
              includes: ['Full day', 'Up to 4 vehicles', '60+ edited images', '30-60 second film with 3 cutdowns', '12-month UAE commercial licence included'],
